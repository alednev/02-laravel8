<header class="max-w-4xl mx-auto mt-20 text-center">
    <div class="max-w-xl mx-auto">
        ...
        <h2 class="inline-flex mt-2">
            By Lary Laracore <img src="/images/lary-head.svg" alt="Lary Head the mascot">
        </h2>
        ...
        <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
            ...
            <!-- Categories -->
            <span class="relative flex lg:inline-flex bg-gray-100 inline-block rounded-xl items-center">
